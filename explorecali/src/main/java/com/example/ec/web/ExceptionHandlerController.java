...
// public void handleInsufficientAuthenticationException(Exception ex,
// HttpServletResponse res) throws IOException {
...
// public void handleException(Exception ex, HttpServletResponse res) throws
// IOException {
// LOGGER.error("Handled Internal Error Exception", ex);
// res.sendError(HttpStatus.INTERNAL_SERVER_ERROR.value(), "Something went
// wrong");
// }
