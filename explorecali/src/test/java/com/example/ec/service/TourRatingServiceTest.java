...
public class TourRatingServiceTest {
    ...
    public void setupReturnValuesOfMockMethods() {
        ...
        lenient().when(tourRatingRepositoryMock.findByTourIdAndCustomerId(TOUR_ID, CUSTOMER_ID))
                .thenReturn(Optional.of(tourRatingMock));
        lenient().when(tourRatingRepositoryMock.findByTourId(TOUR_ID)).thenReturn(Arrays.asList(tourRatingMock));
    }
